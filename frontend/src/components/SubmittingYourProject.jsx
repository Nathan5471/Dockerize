...
services:
  MyAppName:
    ...
    restart: unless-stopped`}
            ...
            <p className="text-xl text-white mb-4">
                All you have to do is fillout <a href="https://forms.hackclub.com/dockerize" target="_blank" className="text-[#f9a535] hover:underline">this form</a> with your project details. After that we will ship you some cool stickers. The top 3 projects based on voting will also win a ZimaBoard that they can use as their home server.
            </p>
        </div>
    );
}