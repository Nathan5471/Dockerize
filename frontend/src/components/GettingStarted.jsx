...
export default function GettingStarted() {
    return (
        <div className="flex flex-col h-full">
            ...
            <p className="text-xl text-white mb-4">
                Join #dockerize in the Hack Club Slack. If you aren't already in the Hack Club Slack, you can joint at <a href="https://hackclub.com/slack" className="text-[#f9a535] hover:underline">hackclub.com/slack</a>.
            </p>
