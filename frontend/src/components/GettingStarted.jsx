...
export default function GettingStarted() {
    return (
        <div className="flex flex-col">
            ...
            <p className="text-xl text-white mb-4">
                Join #dockerize in the Hack Club Slack. If you aren't already in the Hack Club Slack, you can joint at <a href="https://hackclub.com/slack">hackclub.com/slack</a>.
            </p>
